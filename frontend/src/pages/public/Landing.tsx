...
export default function Landing() {
    return (
        <div className="bg-background-dark text-white font-display overflow-x-hidden antialiased selection:bg-primary selection:text-black">
            ...
            <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-40 w-full max-w-5xl px-4">
                <div className="glass-panel rounded-full px-8 py-4 flex items-center justify-between mx-auto max-w-3xl relative overflow-hidden">
                    ...
                    <Link className="flex items-center gap-3 group" to="/">
                        ...
                        <span className="font-bold tracking-widest text-lg">VIZZY</span>
                    </Link>
                    <div className="hidden md:flex items-center gap-8 font-mono text-xs tracking-widest text-gray-400 uppercase">
                    ...
                    <Link to="/login" className="bg-white text-black px-5 py-2 rounded-full text-xs font-bold tracking-widest hover:bg-primary hover:text-white transition-all duration-300 font-mono uppercase">
                        Access
                    </Link>
                </div>
            </nav>
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute bottom-[15%] left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent"></div>
                    {/* Prism Effect (CSS Gradient & Blur) */}
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-6xl w-full">
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 mt-12">
                        <p className="font-mono text-xs md:text-sm text-gray-400 max-w-xs text-center md:text-right uppercase tracking-widest leading-relaxed">
                            The AI-native analytics platform <br /> powered by natural language.
                        </p>
                        <div className="h-12 w-[1px] bg-white/20 hidden md:block"></div>
                        <Link to="/register" className="group relative px-8 py-3 overflow-hidden rounded-sm bg-transparent border border-white/20 hover:border-primary/50 transition-colors duration-300">
                            <div className="absolute inset-0 w-0 bg-primary/10 transition-all duration-[250ms] ease-out group-hover:w-full"></div>
                            <span className="relative font-mono text-xs font-bold tracking-[0.2em] uppercase text-white group-hover:text-primary transition-colors">Start Analyzing</span>
                        </Link>
                    </div>
                </div>
            ...
            <section className="relative py-24 px-6 border-t border-white/5 bg-[#0e0e0e]">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-1 md:gap-4">
                        ...
                        <div className="obsidian-card p-8 md:p-12 rounded-lg relative overflow-hidden group">
                            ...
                            <p className="font-mono text-xs text-gray-500 uppercase tracking-widest mb-4">Inference Engine</p>
                            <h3 className="text-4xl md:text-5xl font-light text-white tracking-tight">GROQ API<span className="text-primary text-2xl align-top text-red-500">&bull;</span></h3>
                            <p className="mt-4 text-sm text-gray-400 font-light font-display italic">Lightning fast SQL generation.</p>
                        ...
                        <div className="obsidian-card p-8 md:p-12 rounded-lg relative overflow-hidden group">
                            ...
                            <p className="font-mono text-xs text-gray-500 uppercase tracking-widest mb-4">Architecture</p>
                            <h3 className="text-4xl md:text-5xl font-light text-white tracking-tight">Llama 3.1<span className="text-2xl align-top"></span></h3>
                            <p className="mt-4 text-sm text-gray-400 font-light font-display italic">Highly precise analytical models.</p>
                        ...
                        <div className="obsidian-card p-8 md:p-12 rounded-lg relative overflow-hidden group">
                            ...
                            <p className="font-mono text-xs text-gray-500 uppercase tracking-widest mb-4">Friction</p>
                            <h3 className="text-5xl md:text-6xl font-light text-white tracking-tight">ZERO<span className="text-2xl align-top"></span></h3>
                            <p className="mt-4 text-sm text-gray-400 font-light font-display italic">Setup to insights in seconds.</p>
            ...
            <section id="features" className="py-32 px-4 relative overflow-hidden">
                {/* Background texture */}
                <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/dark-matter.png')] opacity-20 z-0"></div>
                ...
                <div className="max-w-6xl mx-auto relative z-10 flex flex-col gap-32">
                    ...
                    <div className="flex flex-col gap-6 items-start">
                        ...
                        <h2 className="text-5xl md:text-7xl font-light tracking-tighter max-w-2xl">
                            Intelligent analytics <br /> <span className="text-gray-500 italic font-serif">driven by language.</span>
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center group">
                        <div className="order-2 md:order-1 flex flex-col gap-6">
                            <div className="w-12 h-12 rounded border border-white/10 flex items-center justify-center text-primary mb-4 bg-white/5">
                                <span className="material-symbols-outlined text-3xl">database</span>
                            </div>
                            <h3 className="text-4xl font-light tracking-tight">CONNECT & MAP</h3>
                            <p className="text-lg text-gray-400 font-light font-serif leading-relaxed max-w-md">
                            ...
                            <ul className="flex flex-col gap-3 mt-4 font-mono text-xs text-gray-500 uppercase tracking-wider">
                                <li className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 bg-primary rounded-full"></span> Auto-Schema Detection
                                </li>
                                <li className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 bg-gray-700 rounded-full group-hover:bg-primary transition-colors"></span> CSV & Database Support
                                </li>
                            </ul>
                        </div>
                        {/* Image/Visual */}
                        <div className="order-1 md:order-2 relative aspect-[4/3] rounded-sm overflow-hidden border border-white/5 bg-[#151515]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center group">
                        <div className="order-1 relative aspect-[4/3] rounded-sm overflow-hidden border border-white/5 bg-[#151515]">
                        ...
                        <div className="order-2 flex flex-col gap-6 md:pl-10">
                            ...
                            <h3 className="text-4xl font-light tracking-tight">NATURAL QUERYING</h3>
                            <p className="text-lg text-gray-400 font-light font-serif leading-relaxed max-w-md">
                            ...
                            <ul className="flex flex-col gap-3 mt-4 font-mono text-xs text-gray-500 uppercase tracking-wider">
                                ...
                                <li className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 bg-gray-700 rounded-full group-hover:bg-primary transition-colors"></span> Smart Chart Suggestions
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center group">
                        <div className="order-2 md:order-1 flex flex-col gap-6">
                            ...
                            <h3 className="text-4xl font-light tracking-tight">INSIGHTS & KPIs</h3>
                            <p className="text-lg text-gray-400 font-light font-serif leading-relaxed max-w-md">
                            ...
                            <ul className="flex flex-col gap-3 mt-4 font-mono text-xs text-gray-500 uppercase tracking-wider">
                                ...
                                <li className="flex items-center gap-3">
                                    <span className="w-1.5 h-1.5 bg-gray-700 rounded-full group-hover:bg-primary transition-colors"></span> Trend Extraction
                                </li>
                            </ul>
                        </div>
                        <div className="order-1 md:order-2 relative aspect-[4/3] rounded-sm overflow-hidden border border-white/5 bg-[#151515]">
                ...
                <div className="max-w-7xl mx-auto flex flex-col gap-12">
                    <div className="flex flex-col gap-4 items-center text-center">
                        ...
                        <h2 className="text-3xl font-light tracking-tighter">
                            How it <span className="text-gray-500 italic font-serif">works</span>
                        </h2>
                    </div>
            ...
            {/* CTA Section */}
            <section className="relative py-32 px-4 flex flex-col items-center justify-center bg-background-dark border-t border-white/5">
                ...
                <div className="text-center space-y-8 max-w-2xl relative z-10">
                    <h2 className="text-5xl md:text-8xl font-light tracking-tighter text-white">
                        ENTER THE <br /> <span className="italic font-serif text-gray-500">NEW EPOCH</span>
                    </h2>
                    <p className="font-mono text-sm text-gray-400 tracking-wide">
                        Join the architects of analytical insight.
                    </p>
                    <Link to="/register" className="inline-block mt-8 px-12 py-4 bg-primary text-black font-bold text-sm tracking-widest uppercase hover:bg-white transition-colors duration-300 rounded-sm">
                        Get Access
                    </Link>
                </div>
            </section>
            ...
            {/* Professional Footer */}
            <footer className="bg-[#050505] border-t border-white/5 pt-20 pb-10 px-8 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16 relative z-10">
                        <div className="lg:col-span-2">
                            ...
                            <p className="font-mono text-xs text-gray-400 leading-relaxed max-w-xs mb-8">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Data Connections</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Natural Language SQL</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Automated KPI Boards</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Enterprise Security</a>
                        </div>

                        <div className="flex flex-col gap-4">
                            <h4 className="font-mono text-xs text-white uppercase tracking-widest mb-2 border-l border-primary pl-2">Resources</h4>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Documentation</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">API Reference</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Tutorials</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">System Status</a>
                        </div>

                        <div className="flex flex-col gap-4">
                            <h4 className="font-mono text-xs text-white uppercase tracking-widest mb-2 border-l border-primary pl-2">Company</h4>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">About Us</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Careers</a>
                            <a href="#" className="font-mono text-xs text-gray-500 hover:text-primary transition-colors">Contact Support</a>
                    ...
                    <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] font-mono text-gray-600 uppercase tracking-widest relative z-10">
